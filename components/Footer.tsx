    ...
    <footer className="w-full pt-20 pb-6">
      <div className="flex md:flex-row flex-col justify-between gap-12 ">
        <div className="md:max-w-[40vw]">
          ...
          <p className="text-white-200">A Result-Oriented Software Developer building and managing Web and Mobile Applications that leads to the success of the overall product.</p>
        </div>
